  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10">
        ...
        <div className="md:w-5/6">
            ...
            <p className="text-xl text-gray-700 mt-2">Subtotal: {formatearDinero(producto.precio * producto.cantidad)}</p>
        </div>
        ...
        <div>
            <button
                ...
                font-bold uppercase shadow-md w-full text-center"
            ...
            <button
                type="buton"
                className="bg-red-700 flex gap-2 mt-3 px-5 py-2 text-white rounded-md
                font-bold uppercase shadow-md w-full text-center"
                onClick={() => handleEliminarProducto(propucto.id)}
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
